...
interface Props {
  transaction: EPFTransaction | null;
  visible: boolean;
  onClose: () => void;
  onSave: (tx: {
    id: number;
...
export default function EditEPFTransactionModal({
  transaction,
  visible,
  onClose,
  onSave,
  ...
  const handleDelete = () => {
    ...
    Alert.alert(
      'Delete Transaction',
      `Are you sure you want to delete this ${transaction.type === 'INVEST' ? 'Contribution' : 'Withdrawal'} of ${formatINR(transaction.amount)}?`,
      [
      ...
      >
        <View style={styles.modalContent}>
          ...
          <View style={styles.modalHeader}>
            <View>
              <Text style={styles.modalTitle}>Edit EPF Transaction</Text>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.formScroll}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <TextInput
                ...
                placeholder="e.g. Sep 2026 Salary Contribution"
                placeholderTextColor="#64748B"
              />
            </View>
