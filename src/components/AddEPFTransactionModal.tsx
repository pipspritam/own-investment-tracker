...
export default function AddEPFTransactionModal({
  visible,
  onClose,
  onSave,
}: Props) {
      ...
      >
        <View style={styles.modalContent}>
          ...
          <View style={styles.modalHeader}>
            <View>
              <Text style={styles.modalTitle}>Record EPF Transaction</Text>
              <Text style={styles.modalSubtitle}>Monthly contribution or advance/withdrawal</Text>
            </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.formScroll}>
            ...
            <View style={styles.fieldGroup}>
              ...
              {!isNaN(parsedAmount) && parsedAmount > 0 && (
                <Text style={styles.amountHelperText}>
                  {type === 'INVEST' ? 'Contribution' : 'Withdrawal'}: {formatINR(parsedAmount)}
                </Text>
              )}
            </View>
            ...
            <View style={styles.fieldGroup}>
              ...
              <TextInput
                ...
                placeholder="e.g. Sep 2026 Salary Contribution, Covid advance, etc."
                placeholderTextColor="#64748B"
              />
            </View>
            ...
            <View style={styles.infoBanner}>
              ...
              <Text style={styles.infoBannerText}>
                Total Invested will automatically be calculated as sum of Contributions minus Withdrawals. Current balance is updated manually from your EPFO passbook.
              </Text>
            </View>
          </ScrollView>
