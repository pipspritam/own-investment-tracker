...
import { PPFAccount } from '../types';
import { formatINR, formatPercentage } from '../utils/currency';

interface Props {
  visible: boolean;
  account: PPFAccount | null;
  totalInvested: number;
  onClose: () => void;
  onSave: (currentValue: number, accountNumber?: string, bankName?: string) => void;
}

export default function EditPPFValueModal({
  visible,
  account,
  totalInvested,
  onClose,
  ...
  const handleSave = () => {
    ...
    onSave(val, accountNumber.trim() || undefined, bankName.trim() || undefined);
    onClose();
  };
      ...
      >
        <View style={styles.modalContent}>
          ...
          <View style={styles.modalHeader}>
            <View>
              <Text style={styles.modalTitle}>Update PPF Valuation</Text>
              <Text style={styles.modalSubtitle}>From your bank passbook or netbanking</Text>
            </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.formScroll}>
            ...
            <View style={styles.fieldGroup}>
              <Text style={styles.fieldLabel}>CURRENT PPF BALANCE (₹) *</Text>
              <TextInput
              ...
              <Text style={styles.inputHelperText}>
                Enter the latest closing balance from your passbook/portal.
              </Text>
            </View>
            ...
            <View style={styles.fieldGroup}>
              ...
              <TextInput
                ...
                placeholder="e.g. State Bank of India, Post Office, ICICI"
                placeholderTextColor="#64748B"
              />
            </View>

            <View style={styles.fieldGroup}>
              <Text style={styles.fieldLabel}>PPF ACCOUNT NUMBER</Text>
              <TextInput
                style={styles.textInput}
                value={accountNumber}
                onChangeText={setAccountNumber}
                placeholder="e.g. 10982347101"
                placeholderTextColor="#64748B"
              />
            </View>
          </ScrollView>
